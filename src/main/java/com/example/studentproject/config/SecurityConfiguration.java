...
import static com.example.studentproject.model.Permission.*;
import static com.example.studentproject.security.Role.ADMIN;
import static com.example.studentproject.security.Role.EMPLOYEE;
...
public class SecurityConfiguration {
    ...
    private static final String[] WHITE_LIST_URL = {"/api/v1/auth/**",
            ...
            "/webjars/**",
            "/swagger-ui.html"};
    private final com.example.studentproject.config.JwtAuthenticationFilter jwtAuthFilter;
